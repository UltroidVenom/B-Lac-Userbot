...
if Config.ENABLE_ASSISTANTBOT == "ENABLE":
    ...
    sed.info("B Lac  Bot Have Been Installed Successfully !")
else:
    sed.info("B Lac Has Been Installed Sucessfully !")
    sed.info("You Can Visit @BLAC_USERBOT_OT For Any Support Or Doubts")
