...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest Github Build (https://github.com/B-Lac/B-Lac-Userbot)**",
        ...
        "__INFO:ɓ乛ℓα૮ µรε૨ɓσƭ:Logged in as 557667062__",
        "__INFO:ɓ乛ℓα૮ µรε૨ɓσƭ:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
