...
pm_caption = "➥ **BLAC_USERBOT IS:** `ONLINE`\n\n"
...
pm_caption += "➥ **License** : [GNU General Public License v3.0](https://github.com/B-Lac/B-Lac-Userbot)\n"
pm_caption += "➥ **Copyright** : By [KeinShin@Github](GitHub.com/StarkGang)\n"
pm_caption += "➥ **Check Stats By Doing** `.stat`. \n\n"
pm_caption += "[🇮🇳 Deploy blac Userbot 🇮🇳](https://telegra.ph/FRIDAY-06-15)"
